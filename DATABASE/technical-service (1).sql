...
INSERT INTO `jobcard` (`jobcardId`, `referenceNo`, `vanue`, `category`, `description`, `date_created`, `date_to_fix`, `image`, `artisanId`, `staffId`, `adminId`) VALUES
(3, '1679923303638', '10-212', 'technical', 'mouse', '2023-03-27', NULL, NULL, 2, 1, NULL);
...
--
ALTER TABLE `jobcard`
  MODIFY `jobcardId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
